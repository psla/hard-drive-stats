...
#       s: seconds spent for I/O
    ...
    if previous_time_nanos != -1:
      ...
      normalized_timestamp_seconds = (timestamp_nanos - previous_time_nanos) / 1000000000.1
      print("%.2f\t%.2f\t%.2f\t%d" % (normalized_timestamp_seconds, bytes_read/normalized_timestamp_seconds/1024.0/1024.0, bytes_written/normalized_timestamp_seconds/1024.0/1024.0, temperature))
